// build.mjs — 昼=陽光の波紋／夜=蒼い波紋（JST自動）+ Moon Breath
...
/* 夜の波紋 */
body.night .ripple::before, body.night .ripple::after{
  content:"";position:absolute;inset:0;border-radius:50%;
  border:2px solid rgba(200,220,255,.35);
  animation:waveN 6s ease-in-out infinite;
}
...
/* 昼の波紋（柔らかな陽光） */
body.day .ripple::before, body.day .ripple::after{
  content:"";position:absolute;inset:0;border-radius:50%;
  border:2px solid rgba(255,225,120,.40);
  box-shadow:0 0 20px rgba(255,210,90,.22) inset;
  animation:waveD 7.5s ease-in-out infinite;
}
...
console.log("index.html generated (昼=陽光の波紋 / 夜=蒼い波紋).");
